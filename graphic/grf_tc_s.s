...
**************************************************************************************
	...
	XDEF	Graphic_TC_Blit
	XDEF	Graphic_TC_ClearScreen
	XDEF	Graphic_TC_CopyScreen
	XDEF	Graphic_TC_DrawBox
	XDEF	Graphic_TC_DrawLine
	XDEF	Graphic_TC_DrawPixel
	XDEF	Graphic_TC_DrawSprite
	XDEF	Graphic_TC_DrawTri
	XDEF	Graphic_TC_DrawQuad

	XDEF	Graphic_TC_Blit_Clip
	XDEF	Graphic_TC_ClearScreen_Clip
	XDEF	Graphic_TC_CopyScreen_Clip
	XDEF	Graphic_TC_DrawBox_Clip
	XDEF	Graphic_TC_DrawLine_Clip
	XDEF	Graphic_TC_DrawPixel_Clip
	XDEF	Graphic_TC_DrawSprite_Clip
	XDEF	Graphic_TC_DrawTri_Clip
	XDEF	Graphic_TC_DrawQuad_Clip
...
sGraphicPos_X:          rs.w    1
sGraphicPos_Y:          rs.w    1
...
sGraphicRect_X:         rs.w    1
sGraphicRect_Y:         rs.w    1
sGraphicRect_Width:     rs.w    1
sGraphicRect_Height:    rs.w    1
sGraphicRect_sizeof:    rs.w    1


    ; -------- sGraphicSprite --------
    rsreset

sGraphicSprite_pGfx:            rs.l    1
sGraphicSprite_pMask:           rs.l    1
sGraphicSprite_Width:           rs.w    1
sGraphicSprite_Height:          rs.w    1
sGraphicSprite_GfxPlaneCount:   rs.w    1
sGraphicSprite_MaskPlaneCount:  rs.w    1
sGraphicSprite_sizeof:          rs.w    1


    ; -------- sGraphicCanvas --------
    rsreset

sGraphicCanvas_pVRAM:       rs.l    1
sGraphicCanvas_ColourMode:  rs.w    1
sGraphicCanvas_Width:       rs.w    1
sGraphicCanvas_Height:      rs.w    1
sGraphicCanvas_pad:         rs.w    1
sGraphicCanvas_pFuncs:      rs.l    1
sGraphicCanvas_pClipFuncs:  rs.l    1
sGraphicCanvas_LineOffsets: rs.l    1025
