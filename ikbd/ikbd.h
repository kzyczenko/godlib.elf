...
enum
{
	eIKBD_MOUSEBUTTON_RIGHT = (1<<0),
	eIKBD_MOUSEBUTTON_LEFT  = (1<<1),
};
...
typedef	struct sIKBD
{
	...
	U8		mTeamTapActiveFlag;
	U8		mTeamTapActiveBits;
	...
	U8		mMouseEnabledFlag;
	U8		mJoystickEnabledFlag;
	U8		mPadEnabledFlag;
} sIKBD;
