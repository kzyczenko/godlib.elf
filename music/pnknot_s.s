...
**************************************************************************************
	...
	XDEF	PinkNote_Player

	XDEF	PinkNote_NotePlayChannelA
	XDEF	PinkNote_NotePlayChannelB
	XDEF	PinkNote_NotePlayChannelC

	XREF	gPinkNoteChannel
...
oPinkNoteChannel_Index:         rs.l    1
oPinkNoteChannel_pNotes:        rs.l    1
oPinkNoteChannel_Pause:         rs.w    1
oPinkNoteChannel_ActiveFlag:    rs.b    1
oPinkNoteChannel_LoopingFlag:   rs.b    1

oPinkNoteChannel_ToneFreq:      rs.w    1
oPinkNoteChannel_EnvFreq:       rs.w    1

oPinkNoteChannel_Volume:        rs.b    1
oPinkNoteChannel_NoiseTone:     rs.b    1
oPinkNoteChannel_NoiseFreq:     rs.b    1
oPinkNoteChannel_EnvType:       rs.b    1

oPinkNoteChannel_sizeof:        rs.b    1

	EVEN

	rsreset

oPinkNote_Control:              rs.b    1
oPinkNote_Data0:                rs.b    1
oPinkNote_Data1:                rs.b    1
oPinkNote_Data2:                rs.b    1
...
PinkNote_NotePlayChannelA:
	...
	btst	#4,d0									;	are we using envelopes?
...
.noEnvA:
	...
	btst	#3,d1									;	is there noise on this channel?
...
.noEnvB:
	...
	btst	#4,d1									;	is there noise on this channel?
...
.noEnvC:
	...
	btst	#5,d1									;	is there noise on this channel?
