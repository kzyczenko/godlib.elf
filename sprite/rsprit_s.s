...
**************************************************************************************
	...
	XDEF	RleSprite_Draw
	XDEF	RleSprite_DrawClipY
	XDEF	RleSprite_DrawClip
...
sRleSprite_mWidth:      rs.w    1
sRleSprite_mHeight:     rs.w    1
sRleSprite_mpLines:     rs.w    1      ; daje offset 4 → pasuje do move.l sRleSprite_mpLines(a0),a0


    ; -------- sSpriteRect --------
    rsreset

sSpriteRect_mX:         rs.w    1
sSpriteRect_mY:         rs.w    1
sSpriteRect_mWidth:     rs.w    1
sSpriteRect_mHeight:    rs.w    1
