...
**************************************************************************************
	...
	XDEF	Video_SaveRegsST
	XDEF	Video_RestoreRegsST
	XDEF	Video_SaveRegsSTE
	XDEF	Video_RestoreRegsSTE
	XDEF	Video_SaveRegsTT
	XDEF	Video_RestoreRegsTT
	XDEF	Video_SaveRegsFalcon
	XDEF	Video_RestoreRegsFalcon

	XDEF	Video_UpdateRegsST
	XDEF	Video_UpdateRegsSTE
	XDEF	Video_UpdateRegsTT
	XDEF	Video_UpdateRegsFalcon

	XDEF	Video_GetPalST
	XDEF	Video_SetPalST
	XDEF	Video_GetPalTT
	XDEF	Video_SetPalTT
	XDEF	Video_GetPalFalcon
	XDEF	Video_SetPalFalcon

	XDEF	Video_XbiosSetScreen
	XDEF	Video_XbiosFalconSetLow

	XDEF	Video_SetFalconSTLowVGA
	XDEF	Video_SetFalconSTLowRGBPAL_W
	XDEF	Video_SetFalconSTLowRGBNTSC_W
	XDEF	Video_SetFalconSTLowRGBPAL
	XDEF	Video_SetFalconSTLowRGBNTSC

	XDEF	Video_SetFalconTC50RGB
	XDEF	Video_SetFalconTC60RGB
...
sVideo_pPhysic:             rs.l    1
sVideo_pPalST:              rs.l    1
sVideo_pPalTT:              rs.l    1
sVideo_pPalFalcon:          rs.l    1
sVideo_mCanvasWidth:        rs.w    1
sVideo_Width:               rs.w    1
sVideo_Height:              rs.w    1
sVideo_Mode:                rs.w    1
sVideo_ScrollX:             rs.w    1
sVideo_ScrollY:             rs.w    1
sVideo_ScanLineWords0:      rs.w    1
sVideo_ScanLineWords1:      rs.w    1
sVideo_Hoff:                rs.w    1
sVideo_Voff:                rs.w    1
sVideo_HDB:                 rs.w    1
sVideo_HDE:                 rs.w    1
sVideo_VDB:                 rs.w    1
sVideo_VDE:                 rs.w    1
sVideo_NTSCflag:            rs.b    1
sVideo_WideScreenFlag:      rs.b    1
sVideo_UpdatePhysicFlag:    rs.b    1
sVideo_UpdatePalSTFlag:     rs.b    1
sVideo_UpdatePalTTFlag:     rs.b    1
sVideo_UpdatePalFalconFlag: rs.b    1
sVideo_UpdateScrollFlag:    rs.b    1

	rsreset

sVideoSaveRegsST_pPhysic:   rs.l    1
sVideoSaveRegsST_pLogic:    rs.l    1
sVideoSaveRegsST_Res:       rs.w    1
sVideoSaveRegsST_RegMode:   rs.b    1
sVideoSaveRegsST_RegSync:   rs.b    1

	rsreset

sVideoSaveRegsSTE_pPhysic:      rs.l    1
sVideoSaveRegsSTE_pLogic:       rs.l    1
sVideoSaveRegsSTE_Res:          rs.w    1
sVideoSaveRegsSTE_RegMode:      rs.b    1
sVideoSaveRegsSTE_RegSync:      rs.b    1
sVideoSaveRegsSTE_RegLineWidth: rs.b    1
sVideoSaveRegsSTE_RegScroll:    rs.b    1

	rsreset

sVideoSaveRegsTT_pLogic:        rs.l    1
sVideoSaveRegsTT_pPhysic:       rs.l    1
sVideoSaveRegsTT_pPhysicLow:    rs.b    1
sVideoSaveRegsTT_ResST:         rs.b    1
sVideoSaveRegsTT_ResTT:         rs.w    1
sVideoSaveRegsTT_Sync:          rs.b    1
sVideoSaveRegsTT_LineWidth:     rs.b    1
sVideoSaveRegsTT_Scroll:        rs.b    1

	rsreset

sVideoSaveState_Regs:           rs.l    32
sVideoSaveState_PalST:          rs.w    16
sVideoSaveState_PalFalcon:      rs.l    256
...
Video_SaveRegsSTE:
	...
	move.b	$FFFF8260,sVideoSaveRegsSTE_RegMode(a6)		; save st video shifter
	move.b	$FFFF820A,sVideoSaveRegsSTE_RegSync(a6)		; save sync
	move.b	$FFFF820F,sVideoSaveRegsSTE_RegLineWidth(a6)	; save line width
	move.b	$FFFF8265,sVideoSaveRegsSTE_RegScroll(a6)		; save scroll
